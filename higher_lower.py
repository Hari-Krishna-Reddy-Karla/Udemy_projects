"""This project helps in learning how to pull data from dictionary and use that data 
to build a game on it.

Also utilizes various functions and logical building"""
